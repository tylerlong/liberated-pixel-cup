...
import Longhairback from './longhairback';
...
import Sarahairbottomlayer from './sarahairbottomlayer';
import Sarahairshadowonface from './sarahairshadowonface';
import Sarahairtoplayer from './sarahairtoplayer';
...
class Female extends Folder {
  ...
  longhair() {
    return new Longhair(this.rootPath, this.path);
  }

  longhairback() {
    return new Longhairback(this.rootPath, this.path);
  }
  ...
  sarahairbottomlayer() {
    return new Sarahairbottomlayer(this.rootPath, this.path);
  }

  sarahairshadowonface() {
    return new Sarahairshadowonface(this.rootPath, this.path);
  }

  sarahairtoplayer() {
    return new Sarahairtoplayer(this.rootPath, this.path);
  }
